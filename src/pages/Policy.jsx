...
const Content = () => {
  return (
    <div className="text-sm">
      <p className="mb-4">Last updated: January 13, 2025</p>
      <p className="mb-4">
      ...
      <h2 className="font-semibold text-2xl mb-4 text-yellow-300">
        Interpretation and Definitions
      </h2>
      <h3 className="font-semibold text-xl mb-4">Interpretation</h3>
      <p className="mb-4">
      ...
      <h3 className="font-semibold text-xl mb-4">Definitions</h3>
      ...
      <ul className="list-disc px-4">
        ...
        <li className="mb-2">
          <p className="mb-4">
            ...
            this Agreement) refers to Cryptex Hunt.
          </p>
        </li>
        <li className="mb-2">
          <p className="mb-4">
        ...
        <li className="mb-2">
          <p className="mb-4">
            <strong>Website</strong> refers to Cryptex Hunt, accessible from{" "}
            <a
              href="https://cryptexhunt.tech"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://cryptexhunt.tech
            </a>
          </p>
        </li>
        <li className="mb-2">
      ...
      <h3 className="font-semibold text-xl mb-4">Types of Data Collected</h3>
      <h4 className="text-lg mb-2">Personal Data</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg mb-2">Tracking Technologies and Cookies</h4>
      <p className="mb-4">
      ...
      <h3 className="font-semibold text-xl mb-4">Use of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="font-semibold text-xl mb-4">Delete Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h4 className="text-lg mb-2">Business Transactions</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg mb-2">Law enforcement</h4>
      <p className="mb-4">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-lg mb-2">Other legal requirements</h4>
      <p className="mb-4">
      ...
      <ul className="list-disc px-4">
        <li className="mb-2">By email: syeddarainquadri@gmail.com</li>
      </ul>
    </div>
  );
};
  ...
  return (
    <div className="text-[#10ab66] w-full pb-12">
      <div className="max-w-sm sm:max-w-xl md:max-w-3xl lg:max-w-4xl bg-emerald-800 backdrop-filter backdrop-blur-[6px] bg-opacity-30 mx-auto mt-12 rounded-2xl border-[2px] border-solid border-[#10ab66] shadow-yellow-400 shadow-md py-4">
        ...
        <div className="pb-2 px-8 font-poppins font-normal pt-4 text-gray-300">
          <Content />
        </div>
      </div>
    </div>
